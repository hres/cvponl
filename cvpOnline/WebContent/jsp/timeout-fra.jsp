...
<div class="page"><div class="core">
	...
	<div class="center"><br/>
			<h1><a name="contf" id="contf"></a>
			<!-- FRENCH CONTENT TITLE BEGINS | DEBUT DU TITRE DU CONTENU FRANCAIS -->
			Session expirée
			<!-- FRENCH CONTENT TITLE ENDS | FIN DU TITRE DU CONTENU FRANCAIS -->
			</h1>
			<div><br/></div>
			<p>Votre session est expirée</p>
			<p>(29 minutes d'inactivité).</p>
			<p>Veuillez essayer à nouveau!</p>
			<p><br/>
				<html:link action="/start-debuter.do?lang=fra" >Retourner à l'application</html:link>
			</p>
			<div><br/></div>
			</div>
	</div>
	...
	<div class="footer">
		...
		<div class="foot2">&nbsp;</div>
		<div class="foot3">
		<a href="<bean:message bundle="clfRes" key="important.link"/>" lang="fr" xml:lang="fr">Avis importants</a>
		</div>
	</div>
